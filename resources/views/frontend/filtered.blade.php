                    ...
                    <div class="search-panel" itemscope="" itemtype="https://schema.org/SearchResultsPage">
                        <div id="bread-crumb" class="std-side-padding-px">
                           {{--  <span itemscope="" itemtype="https://schema.org/BreadcrumbList">
                            ...
                            @if(request()->query('DepartmentFilter'))
                            @foreach(request()->query('DepartmentFilter') as $span)
                            <span class="h4">
                                    &gt;
                                </span>
                        ...
                        <div class="search-result-bar std-side-padding" id="result-count">
                            <div class="search-item-count">
                                <span class="resultsShown">
                                    Showing page <span class="current">{{ $products->currentPage() }}</span> of 
                                </span>
                            ...
                            <div class="sort-by-desk select-container">
                                ...
                                <select name="orderby" class="link-3" id="orderby" aria-label="Sort search by">
                                    ...
                                    <option value="popular" {{ (request()->query('orderby') == 'popular')? 'selected':'' }}>
                                        Most Popular
                                    </option>
                                    <option value="relative" {{ (request()->query('orderby') == 'relative')? 'selected':'' }}>
                                        Relevance
                                    </option>
                                    <option value="all" {{ (request()->query('orderby') == 'all')? 'selected':'' }}>
                                        A - Z
                                    </option>
                                    <option value="byreview" {{ (request()->query('orderby') == 'byreview')? 'selected':'' }}>
                                        Review Rating
                                    </option>
                                    <option value="review-count" {{ (request()->query('orderby') == 'review-count')? 'selected':'' }}>
                                        Review Count
                                    </option>
                                    <option value="asc" {{ (request()->query('orderby') == 'asc')? 'selected':'' }}>
                                        Price: Low to High
                                    </option>
                                    <option value="desc" {{ (request()->query('orderby') == 'desc')? 'selected':'' }}>
                                        Price: High to Low
                                    </option>
                                </select>
                            </div>
                                                        ...
                                                        <div>
                                                            <label class="link-3 block-padding">
                                                                <input class="gender_1" type="checkbox" name="GenderFilter[]"
                                                                    value="Women" aria-label="Filter by: Women"@if(request()->query('GenderFilter'))@foreach(request()->query('GenderFilter') as $gender)
                                                                    {{ $gender == 'Women'? 'checked':'' }}@endforeach @endif>
                                                        ...
                                                        <div>
                                                            <label class="link-3 block-padding">
                                                                <input class="gender_2" type="checkbox" name="GenderFilter[]"
                                                                    value="Men" aria-label="Filter by: Men" @if(request()->query('GenderFilter'))@foreach(request()->query('GenderFilter') as $gender)
                                                                    {{ $gender == 'Men'? 'checked':'' }}@endforeach @endif>
                                                                <span class="checkbox-box">
                                                        ...
                                                        <div>
                                                            <label class="link-3 block-padding">
                                                                <input class="gender_3" type="checkbox" name="GenderFilter[]"
                                                                    value="Unisex" aria-label="Filter by: Unisex" @if(request()->query('GenderFilter'))@foreach(request()->query('GenderFilter') as $gender)
                                                                    {{ $gender == 'Unisex'? 'checked':'' }}@endforeach @endif>
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                             ...
                                             <div class="r section-filter-block block-padding scent-filter-block">
                                                <div class="pop link-3">
                                                    ...
                                                    <div class="pop-content">
                                                        ...
                                                        $types = \App\Models\Type::where('status',1)->get()->toArray();
                                                        $scents = \App\Models\ScentNote::where('status',1)->get()->toArray();
                                                        $departments = \App\Models\Department::where('status',1)->get()->toArray();
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="BrandFilter[]"
                                                                    value="{{  $brand['name']}}" aria-label="Filter by: {{  $brand['name']}}" @if(request()->query('BrandFilter'))@foreach(request()->query('BrandFilter') as $check_brand)
                                                                    {{ $brand['name'] == $check_brand? 'checked':'' }}@endforeach @endif >
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli" @if(request()->query('BrandFilter'))@foreach(request()->query('BrandFilter') as $check_brand)
                                                                    {{ $brand['name'] == $check_brand? 'checked':'' }}@endforeach @endif>
                                                                         <span class="checkbox-box">
                                                                            <img class="lazy-img"
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="TypeFilter[]"
                                                                    value="{{ $type['name'] }}" aria-label="{{ $type['name'] }}" @if(request()->query('TypeFilter'))@foreach(request()->query('TypeFilter') as $check_type)
                                                                    {{ $type['name'] == $check_type? 'checked':'' }}@endforeach @endif>
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli" @if(request()->query('TypeFilter'))@foreach(request()->query('TypeFilter') as $check_type)
                                                                    {{ $type['name'] == $check_type? 'checked':'' }}@endforeach @endif>
                                                                         <span class="checkbox-box">
                                                                            <img class="lazy-img"
                                                                                src="https://img.fragrancex.com/images/ajax-loader-new.gif"
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="DepartmentFilter[]"
                                                                    value="{{ $dept['name'] }}" aria-label="Filter by: Bergamot" @if(request()->query('DepartmentFilter'))@foreach(request()->query('DepartmentFilter') as $check_dept)
                                                                    {{ $dept['name'] == $check_dept? 'checked':'' }}@endforeach @endif>
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli" @if(request()->query('DepartmentFilter'))@foreach(request()->query('DepartmentFilter') as $check_dept)
                                                                    {{ $dept['name'] == $check_dept? 'checked':'' }}@endforeach @endif>
                                                                         <span class="checkbox-box">
                                                                            <img class="lazy-img"
                                                                                src="https://img.fragrancex.com/images/ajax-loader-new.gif"
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="ScentFilter[]"
                                                                    value="{{ $scent['name'] }}" aria-label="Filter by: Bergamot" @if(request()->query('ScentFilter'))@foreach(request()->query('ScentFilter') as $check_scent)
                                                                    {{ $scent['name'] == $check_scent? 'checked':'' }}@endforeach @endif>
                                                                <span  class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli"  @if(request()->query('ScentFilter'))@foreach(request()->query('ScentFilter') as $check_scent)
                                                                    {{ $scent['name'] == $check_scent? 'checked':'' }}@endforeach @endif>
                                                                         <span class="checkbox-box">
                                                                            <img class="lazy-img"
                                                                                src="https://img.fragrancex.com/images/ajax-loader-new.gif"
                        ...
                        <div id="search-result-content" class="c4-9-of-12 c5-10-of-12">
                            ...
                            <div class="search-results std-side-padding put-content-here">
                                <div class="search-result-grid">
                                    ...
                                    <input value="https://www.a.com/shopping/type/perfume" type="hidden" id="search-current-page-url">
                                    <input value="false" type="hidden" id="is-brand-with-facets-request">
                                    <input value="false" type="hidden" id="is-department-with-facets-request">
                                    <input value="false" type="hidden" id="is-subcategory-with-facets-request">
    ...
    <script type="text/javascript">
      ...
      $(document).on('change','.link-3',function(){
        ...
        $.ajax({
          ...
          $('.search-loader').prepend('<img id="loader" src="https://i.pinimg.com/originals/d7/7b/ce/d77bce75b53ed81f656be3f4249b372b.gif"/>')
 ...
 beforeSend:function(){
  ...
  success: function(response){
   ...
   if(response.view){
    ...
    $(".put-content-here").html(response.view);
    $('span .current').html(response.current);
    $('span .totalResults').html(response.last);
