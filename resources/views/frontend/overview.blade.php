                ...
                <div id="search-load-wrap">
                    <div class="search-panel" itemscope="" itemtype="https://schema.org/SearchResultsPage">
                        ...
                        <h1 class="search-term h1 std-side-padding-px">
                            Discount {{ $category->parent->name??'' }} for {{ $category->name??'Men & Women' }}
                        </h1>

                        <div class="search-result-bar std-side-padding" id="result-count">
                            <div class="search-item-count">
                                <span class="resultsShown">
                                    Showing page <span class="current">{{ $products->currentPage() }}</span> and total product
                                </span>
                        ...
                        <div class="search-filter-options c4-3-of-12 c5-2-of-12 std-side-padding">
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="BrandFilter[]"
                                                                    value="{{  $brand['name']}}" aria-label="Filter by: {{  $brand['name']}}">
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="TypeFilter[]"
                                                                    value="{{ $type['name'] }}" aria-label="{{ $type['name'] }}" {{ (Request()->segment(3) == $type['name'])? 'checked':'' }}>
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli" {{ (Request()->segment(3) == $type['name'])? 'checked':'' }}>
                                                                        <span class="checkbox-box">
                                                                            <img class=""
                                                                                src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                                data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class=" block-padding">
                                                                <input class="scent_1" type="checkbox" name="DepartmentFilter[]"
                                                                    value="{{ $dept['name'] }}" aria-label="" {{ (Request()->segment(3) == $dept['slug'])? 'checked':'' }}>
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                ...
                                                                <div>
                                                                    <label class=" block-padding">
                                                                        <input class="scent_11" type="checkbox"
                                                                            ...
                                                                            aria-label="Filter by: Patchouli" {{ (Request()->segment(2) == $dept['slug'])? 'checked':'' }}>
                                                                        <span class="checkbox-box">
                                                                            <img class=""
                                                                                src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                                data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class="block-padding">
                                                                <input class="price_1" type="checkbox" name="PriceFilter[]"
                                                                    value="1500" aria-label="Filter by: Under $10">
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class="block-padding">
                                                                <input class="price_2" type="checkbox" name="PriceFilter[]"
                                                                    value="3000" aria-label="Filter by: $10 - 25">
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class="block-padding">
                                                                <input class="price_3" type="checkbox" name="PriceFilter[]"
                                                                    value="5000" aria-label="Filter by: $25 - 50">
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                        ...
                                                        <div>
                                                            <label class="block-padding">
                                                                <input class="price_4" type="checkbox" name="PriceFilter[]"
                                                                    value="100000000000000000000000000000000" aria-label="Filter by: $50 +">
                                                                <span class="checkbox-box">
                                                                    <img class=""
                                                                        src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                                                                        data-src="https://img.fragrancex.com/images/assets/ui/checkmark-white.svg"
                            ...
                            <span id="mobile-search-filter-head" class=" section-filter-block">
                                <span class="search-term h1">Discount {{ $category->parent->name??'' }} for {{ $category->name??'Men & Women' }}</span>
                        ...
                        <div id="brand-desc-mobile-section" class="std-side-padding">
                            <div class="brand-desc-mobile">
                                ...
                                <div class="span" id="product-read-more-text" style="display: none;">
                                    ...
                                    service. If you have any questions, please read our <a href="">FAQs</a>; if you need additional support while shopping, feel free to <a href="#">contact us</a>                                    so that our team can help you with your purchase promptly. We even offer a loyalty program: Sign up and you’ll be able to earn extra discounts on future orders. When you shop with FragranceX, you’ll soon see how easy
    ...
    var filteredValues='';
      ...
      $(document).on('change','.link-3',function(){
        ...
        $.ajax({
          ...
          $('.search-loader').append('<img class="" src="https://i.pinimg.com/originals/d7/7b/ce/d77bce75b53ed81f656be3f4249b372b.gif"/>')
        ...
        $(document).on("click", "#ajax-filter .page-link", function(e) {
